/*!
 * NOTE: THIS FILE HAS BEEN MODIFIED ON SLIDER TO FORCE _animateOff=false; WHEN SETTING VALUE.
 * DON'T UPDATE IT WITHOUT KNOWING THAT.
 * jQuery UI 1.8.12
 *
...
this._trimAlignValue(d);var old=this._animateOff;this._animateOff=false;this._refreshValue();this._animateOff=old;this._change(null,0)}else return this._value()},values:function(d,e){var f,g,a;if(arguments.length>1){this.options.values[d]=this._trimAlignValue(e);this._refreshValue();this._change(null,d)}else if(arguments.length)if(b.isArray(arguments[0])){f=this.options.values;g=arguments[0];for(a=0;a<f.length;a+=1){f[a]=this._trimAlignValue(g[a]);this._change(null,a)}this._refreshValue()}else return this.options.values&&this.options.values.length?this._values(d):
