/****************************************************************
CAUTION PLUGIN CHANGED by Toily:

LINE 4730:
      
      current:
        $("<style type='text/css'> hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } </style>").appendTo("head");
...
IE8 has issues with doc.createStyleSheet() changed to jquery instead; Note on update;
